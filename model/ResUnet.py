...
class expansive_mix(nn.Module):
    def __init__(self, in_channels, mid_channels, out_channels):
        super(expansive_mix, self).__init__()

        self.mix = avgMixAdd(in_channels, out_channels, mid_channels)
        self.block = nn.Sequential(
...
class Resnet34_Unet_Mix(nn.Module):
    def __init__(self, in_channel, out_channel, pretrained=False):
        super(Resnet34_Unet_Mix, self).__init__()
        ...
        # Decode
        self.conv_decode4 = avgMixAdd(1024, 512, 512)
        self.conv_decode3 = avgMixAdd(512, 256, 256)
        self.conv_decode2 = avgMixAdd(256, 128, 128)
        self.conv_decode1 = avgMixAdd(128, 64, 64)
        self.conv_decode0 = expansive_block(64, 32, 32)
        self.final_layer = final_block(32, out_channel)
